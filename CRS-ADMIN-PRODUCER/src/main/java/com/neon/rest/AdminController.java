...
public class AdminController {
	 ...
	 */
	@RequestMapping(produces = MediaType.APPLICATION_JSON, 
			method = RequestMethod.GET, value = "/approve/{registerId}")
	@ResponseBody
	public  boolean approveRegistration(@PathVariable("registerId") int registerId) {
	
		return adminService.approveRegistration(registerId);
