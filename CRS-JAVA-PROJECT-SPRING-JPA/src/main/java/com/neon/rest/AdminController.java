...
import com.neon.exception.ProfessorAddException;
...
public class AdminController {
	...
	@Autowired
	private ProfessorAddException addException;
	...
	public ResponseEntity<String> addProfessor(@RequestBody Professor professor) {
		Professor addprof = adminService.addProfessor(professor);
		if(!addprof.equals(professor)) {
			System.out.println(addprof.equals(professor));
			return new ResponseEntity<String>(addException.getMessage() ,HttpStatus.NOT_FOUND);}
		else {
